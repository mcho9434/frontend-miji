const PORTFOLIO_DATA = [
  ...
  },
  {
    ...
    body: "Beacons aggregates creator tools, providing creators an all-in-one toolkit to develop their business including link-in-bio, email marketing, finances, and even store products. I worked on the growth team, aiming to hit key indicators and target key growth factors. Beacons is great in that interns work the same way as full-times leading to hyper-fast learning. I’m thankful that I got to work in an intensive startup environment with great mentorship and complex engineering problems. Plus there was an office dog! That's Winnie :) ",
